...
storage_file = 'blockchain.json'  # Define your file path
...
def submit_claim():
    if request.method == 'GET':
        claim_number = "123456"  # Example claim number
        claim_details = "This is a test claim."  # Example claim details
        ...
        try:
            ...
            if (claim_number_input == "123456" and 
                ...
                # Redirect to pending_claims page after successful submission
...
def pending_claims():
    # You can return pending claims information here
